...
class Home extends CI_Controller {
	...
	public function index(){
		...
		$data = array(
			...
			"tiket" => $this->Crud_m->read('tbl_kategori', array('status' => 1))->result(),
	...
	public function Simpan(){
		...
		$this->email->from('noreply@monstrosix.com', 'Monstrosix');
		$this->email->to($email); 
		$this->email->subject('Tiket Monstrosix - '.$tgl_pesan);
		...
		$htmlContent .= '<p>Atau bisa COD silahkan hubungi Nomor Whatsapp berikut : </p>';
		...
		$htmlContent .= '<p>Email dibuat secara otomatis, dimohon untuk tidak membalas melalui email ini. Jika butuh bantuan dapat menghubungi kami di info@monstrosix.com</p>';
