                ...
                <div class="col-sm-5 left-wrapper">
                    <div class="event-banner-wrapper">
                        ...
                        <div class="event-banner-wrapper-sosmed">
                            ...
                            <a href="https://line.me/ti/p/%40uqr5723g" target="_blank">
                    ...
                    <div class="modal-body">
                        <form>
                            ...
                            <div class="contactForm">
                                ...
                                <div class="form-group">
                                    <input type="email" class="form-control" name="email" id="email" placeholder="Enter your Email Adress">
                                </div>
                                <div class="form-group">
                                    <input type="number" class="form-control" name="no_telp" id="no_telp" placeholder="Enter your Mobile Number">
                                </div>
        ...
        if(nama_pemesan == ""){
            ...
            $.ajax({
                ...
                complete: function(data){
                    ...
                    alert("Terimakasih, silahkan periksa inbox/spam di email anda.");
                    location.reload();
                },
