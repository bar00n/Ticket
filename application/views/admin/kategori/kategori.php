				...
				<tbody>
					<?php 
						foreach($kategori as $item){
							if($item->status == 1){
								$status = "<button type='button' class='btn btn-success'><i class='fa fa-eye' aria-hidden='true'></i> Aktif</button>";
							}else{
								$status = "<button type='button' class='btn btn-danger'><i class='fa fa-eye-slash' aria-hidden='true'></i> Non Aktif</button>";
							}
							echo "
								<tr class='gradeU'>
